...
public class AzureUILeaderboard : MonoBehaviour 
{
	...
	[SerializeField]
	public string AzureEndPoint = "https://eranmatematika.azure-mobile.net/"; // Your Connection URL
	
	[SerializeField]
	public string ApplicationKey = "guHAERzjPvvdZecjtoxpbPhArxoQIz37"; // Your API Key
